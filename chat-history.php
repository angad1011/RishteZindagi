    ...
    <div class="container gt-view-profile">
    	...
    	<div class="row">
        	...
        	<div class="col-xxl-3 col-xl-4 col-xs-16 col-sm-16">
            	...
            	<a class="btn btn-darkblue gt-margin-bottom-20 visible-xs visible-lg visible-md visible-sm" role="button" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample" >
