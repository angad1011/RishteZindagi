                   		...
                   		<div id="owl-demo-1" class="owl-carousel">
                            ...
                            <div class="item">
								<div class="text-center">
                                    ...
                                    <a href="member-profile?view_id=<?php echo $Row->matri_id;?>" class="btn btn-darkblue gt-margin-top-10"><i class="fa fa-eye gt-margin-right-10"></i><?php echo $lang['View Profile']; ?></a>
                                </div>
                            </div>
                			<?php }?>
                		</div>
