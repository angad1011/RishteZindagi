					...
					?>
					 ...
					 <div class="row">
						...
						<div class="col-xs-16 form-group text-center">
							<input class="btn btn-darkblue" type="submit" name="req-password"  value="Send Request">
							<a data-toggle="modal" data-target="#myModal6" onClick="view_protect_photo('<?php echo $_GET['id'];?>');">
							  <input class="btn btn-darkblue" type="button" name="req-password" value="<?php echo $lang['Click here if you have password']; ?>" >
							</a>
