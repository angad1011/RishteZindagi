										...
										<li role="presentation" class="<?php if(isset($_GET['blockprofilediv'])){echo "active";}?>">
                   						...
                   						<li role="presentation" class="<?php if(isset($_GET['contactdiv'])){echo "active";}?>">
											<a href="#contact-setting" aria-controls="contact-setting" role="tab" data-toggle="tab">
												<i class="fa fa-phone-alt gt-margin-right-10 fa-lg"></i> <?php echo $lang['Contact show setting']; ?>
										  	</a>
                    					</li>
														...
														<div class="col-xxl-4 col-xl-4 col-xs-10 col-sm-10 col-md-10 col-lg-6">
															<h5>
																<span class="text-danger gt-mar" id="photo_view_status">
																	<i class="fa fa-eye gt-margin-right-10"></i><?php echo $lang['Show To All']; ?>
																</span>
															</h5> 
														</div>
														...
														<?php if($get_data->photo_pswd=='' || $get_data->photo_pswd=='0' ){ ?>
															<div class="col-xxl-5 col-xl-5 col-xs-16 col-sm-16 col-md-16 col-lg-6"> 
																<a class="" role="button" data-toggle="collapse" href="#photo-settings-2" aria-expanded="false" aria-controls="photo-settings-2">
																	<?php echo $lang['Set Password for protect photo']; ?>
																</a> 
															</div>
															<?php }else{?>
															<div class="col-xxl-5 col-xl-5 col-xs-16 col-sm-16 col-md-16 col-lg-6"> 
																<a class="" role="button" data-toggle="collapse" href="#photo-settings-2" aria-expanded="false" aria-controls="photo-settings-2">
																	<?php echo $lang['Change Password for protect photo']; ?>
																</a>
															</div>
															...
															<div class="col-xxl-6 col-xl-5 col-xs-16 col-sm-16 col-md-16 col-lg-6">
																<a class="gt-cursor" onClick="removephotopass();">
																	<?php echo $lang['Remove Password from protect photo']; ?>
																</a>
															</div>
														<?php }?>
													</div>
            ...
            function photovisbility(pval) {
                ...
                jQuery.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(pval == '0') {
                            $('#photo_view_status').html('<i class="fa fa-eye-slash gt-margin-right-10"></i><?php echo $lang['']; ?>Hidden For All');
                        } else if(pval == '1') {
                            $('#photo_view_status').html('<i class="fa fa-eye gt-margin-right-10"></i><?php echo $lang['']; ?>Visible To All Members');
                        } else if(pval == '2') {
                            $('#photo_view_status').html('<i class="fa fa-eye gt-margin-right-10"></i><?php echo $lang['']; ?>Visible To Paid Members');
                        }
            ...
            function contactvisbility(pval) {
                ...
                jQuery.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(pval == '1') {
                            $('#contact_view_status').html('<i class="fa fa-eye gt-margin-right-10"></i><?php echo $lang['']; ?>Show To Paid Members');
                        } else if(pval == '0') {
                            $('#contact_view_status').html('<i class="fa fa-eye gt-margin-right-10"></i><?php echo $lang['']; ?>Show To Express Interest &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Accepted Paid Member');
                        }
                        //alert('Your photo view preference is edited Successfully.');
                    },
                });
